...
def guardar_parametros(tfEntrada, tfInicioIntervalo, tfFinalIntervalo, tfErro, tfPrecisao):
    ...
    if funcao(a)*funcao(b)>=0:
        lbErro = Label(janela, text = "Error on bisection method")
        ...
        for i in range(k+1):
            ...
            if funcao(a_n)*funcao(m_n)<0:
                ...
                lbFalha = Label(janela, text = "The bisection method failed")
        ...
        lbIteracoes = Label(janela, text = "Iterations number = "+str(k))
